...
case $# in
    1) echo -e "`colour greenlight ${0##./}` is starting instances specified in input file `colour brownlight $1`";;
    0|*) echo -e "`colour gl ${0##./}` starts instances previously created."
	 echo " "
